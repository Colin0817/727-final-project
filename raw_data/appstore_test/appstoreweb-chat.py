...
def fetch_reviews_with_fixed_pages(app_id, keywords, start_date, end_date, output_csv, max_pages=20):
    reviews = []
        ...
        try:
            ...
            for entry in entries:
                try:
                    ...
                    if any(keyword.lower() in content.lower() for keyword in keywords) and start_date <= date <= end_date:
                        reviews.append({
                            "content": content,
...
if __name__ == "__main__":
    ...
    app_id = "6448311069"
    keywords = ["PLUS", "Upgrade", "Premium", "claude", "gpt4"]
    ...
    output_csv = "app_store_reviews_chatgpt.csv"
    max_pages = 10

    fetch_reviews_with_fixed_pages(app_id, keywords, start_date, end_date, output_csv, max_pages)
